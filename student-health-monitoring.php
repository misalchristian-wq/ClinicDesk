  ...
  <div class="login-shell">
    ...
    <section class="login-hero">
      ...
      <div class="hero-footer">
        ClinicDesk Prototype · School Clinic Health Monitoring
      </div>
    </section>
    ...
    <section class="login-panel">
      <div class="login-card">
        ...
        <form @submit.prevent="loginUser">
          ...
          <div class="role-note" v-if="role === 'Teacher'">
            Teacher accounts are verified through Firebase Authentication.
          </div>

          <div class="role-note" v-if="role && role !== 'Teacher'">
            {{ role }} accounts are verified through the local XAMPP/MySQL account database.
          </div>
...
createApp({
  data() {
    return {
      firebaseApiKey: "PASTE_YOUR_FIREBASE_WEB_API_KEY_HERE",
      role: "",
      email: "",
      password: "",
      showPassword: false,
